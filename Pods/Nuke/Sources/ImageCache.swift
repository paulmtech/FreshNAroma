...
internal final class _Cache<Key: Hashable, Value> {
    ...
    init(costLimit: Int, countLimit: Int) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(didEnterBackground), name: NSNotification.Name.UIApplicationDidReceiveMemoryWarning, object: nil)
        #endif
    }
